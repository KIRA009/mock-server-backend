...
urlpatterns = list(
    map(
        ...
        [
            ...
            ("relative-endpoint/status_code/add/", add_status_code),
            ("relative-endpoint/status_code/set/", set_status_code),
            ("relative-endpoint/status_code/update/", update_status_code),
            ("relative-endpoint/status_code/delete/", delete_status_code),
